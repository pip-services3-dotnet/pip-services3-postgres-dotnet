# Development and Testing Guide <br/> Pip.Services PostgreSQL for .NET
...
- Download and install PostgreSQL database from https://www.postgres.org/downloads
...
```bash
nuget pack pip-services3-postgres-dotnet.nuspec
```

Publish the package on nuget global repository

```bash
nuget push PipServices3.Postgres.XXX.nupkg -Source https://www.nuget.org/api/v2/package
```
