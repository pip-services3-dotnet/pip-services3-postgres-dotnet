...
//using PostgreSQL.Bson.Serialization;
...
//    /// </code>
//    /// </example>
//    public class IdentifiablePostgresPersistence<T, K> : PostgresPersistence<T>, IWriter<T, K>, IGetter<T, K>, ISetter<T>
...
//        public IdentifiablePostgresPersistence(string collectionName)
//            : base(collectionName)
//        { }
